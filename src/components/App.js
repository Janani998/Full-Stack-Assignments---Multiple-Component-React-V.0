    ...
    return (
      <>
        ...
        <p data-ns-test="project-description">
          ...
          during the time period of the election time and the notification will
          be sent to the user's registered mobile number about the start and
          remaining time of voting. Once a user completes his/her voting process
          then he/she will not be allowed to vote again. The voting details of
          all the users will be stored in the backend.
        </p>
      </>
    );
  }
